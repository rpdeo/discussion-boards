...
class Topic(models.Model):
    ...
    def get_last_posts(self, count=None):
        if count is None:
            count = 5
...
class Post(models.Model):
    ...
    # available as Topic.posts
    topic = models.ForeignKey(
        Topic, related_name='posts', on_delete=models.CASCADE)
    # available as User.posts
    created_by = models.ForeignKey(
        User, related_name='posts', on_delete=models.CASCADE)
    # the below '+' indicates to django that this reverse relationship is not essential.
